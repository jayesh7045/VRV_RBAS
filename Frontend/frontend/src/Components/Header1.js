...
function Header() {
  ...
  const handleLogout = () => {
    localStorage.removeItem("username"); // Removes the username from local storage
  ...
  useEffect(()=>{
    ...
    const d = localStorage.getItem('hasacc');
    sethasacc(d);
  }, [])
  return (
    <div>
        ...
        <nav class=" border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
          <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="https://flowbite.com" class="flex items-center">
              ...
              <span class="self-center text-xl font-bold tracking-wider pl-[0.5rem] text-[1.5rem] whitespace-nowrap dark:text-white">
                <span className="text-red-600">
                  Campus<span className="text-blue-600">Quarters</span>
                </span>
              </span>
            </a>
            ...
            >
              ...
              {owner && hasacc && <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                Register you own Hostel
              </button>}
            </div>
            <div></div>
          </div>
